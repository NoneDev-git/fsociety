...
A Penetration Testing Framework, you will have every script that a hacker needs. Works with Python 2 (install on kali: https://www.kali.org/docs/general-use/using-eol-python-versions/). For a Python 3 version see our updated version at [`fsociety-team/fsociety`](https://github.com/fsociety-team/fsociety).
